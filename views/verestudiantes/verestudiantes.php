...
require_once __DIR__ . '/../../controllers/estudiantescontrollers/verestudiantes.php';
...
<div class="tabla-container">
    ...
    <?php if (!empty($estudiantes)): ?>
                    ...
                    <tr>
                        <form method="post" id="form-<?= htmlspecialchars($estudiante['carnet']) ?>">
                            <input type="hidden" name="id_estudiante"
                                value="<?= htmlspecialchars($estudiante['id_estudiante']) ?>">

                            <td><input type="text" name="nombre" value="<?= htmlspecialchars($estudiante['nombre_completo']) ?>"
                                    readonly></td>
                            <td><input type="text" name="carnet" value="<?= htmlspecialchars($estudiante['carnet']) ?>"
                                    readonly></td>
                            <td><input type="number" name="edad" value="<?= htmlspecialchars($estudiante['edad']) ?>" readonly>
                            </td>
                            <td><input type="text" name="direccion" value="<?= htmlspecialchars($estudiante['direccion']) ?>"
                                    readonly></td>
                            <td><input type="text" name="telefono" value="<?= htmlspecialchars($estudiante['telefono']) ?>"
                                    readonly></td>
                            <td><input type="email" name="correo" value="<?= htmlspecialchars($estudiante['correo']) ?>"
                                    readonly></td>
                            ...
                            <td>
                                ...
                                ?>
                                <input type="text" name="carrera_nombre" value="<?= htmlspecialchars($nombreCarrera) ?>"
                                    readonly class="carrera-nombre">
                                <select name="carrera" class="carrera-select" style="display:none;">
                                    <?php foreach ($carreras as $c): ?>
                                        <option value="<?= $c['id_carrera'] ?>"
                                            <?= ($c['id_carrera'] == $estudiante['id_carrera']) ? 'selected' : '' ?>>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <button type="submit" name="eliminar" class="eliminar-btn btn-accion"
        ...
        <!-- Botón PDF -->
        <form action="/pdf/reporteestudiantes.php" method="POST" target="_blank">
